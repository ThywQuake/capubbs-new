...
export function RichTextEditor({
  ...
  const splitPaneClassName = isMobileViewport
    ? `flex flex-col ${isAutoHeightEnabled ? 'min-h-[40vh]' : 'h-[40vh]'}`
    : `flex flex-row ${isAutoHeightEnabled ? 'min-h-[40vh]' : 'h-[40vh]'}`;
    ...
    >
      <div className="border-b border-zinc-200/80 bg-white/70 dark:border-white/10 dark:bg-white/[0.04]">
              ...
              <>
                ...
                <div className="flex h-8 items-center gap-1 rounded-md border border-zinc-200 bg-white/70 px-1.5 dark:border-white/10 dark:bg-white/[0.06]">
                  ...
                  <select
                    ...
                    className="h-7 max-w-[7.25rem] bg-transparent text-xs font-bold text-[#385772] outline-none dark:text-white"
                  >
                ...
                <div className="flex h-8 items-center gap-1 rounded-md border border-zinc-200 bg-white/70 px-1.5 dark:border-white/10 dark:bg-white/[0.06]">
                  ...
                  <select
                    ...
                    className="h-7 w-[3.75rem] bg-transparent text-xs font-bold text-[#385772] outline-none dark:text-white"
                  >
              ...
              <>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-md border border-transparent text-[#385772] transition hover:border-zinc-200 hover:bg-zinc-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] dark:text-white dark:hover:border-white/10 dark:hover:bg-white/[0.1]"
                  >
                      ...
                      <div className="mt-3 grid grid-cols-3 gap-1.5">
                        {commonTextColors.map((color) => (
                          <button
                            ...
                            className="h-7 rounded-md border border-zinc-200 shadow-sm transition hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] dark:border-white/10"
                      ...
                      <label className="mt-3 block text-[0.7rem] font-bold text-zinc-500 dark:text-zinc-400">
                        ...
                        <div className="mt-1 flex gap-2">
                          <input
                            ...
                            className="h-8 min-w-0 flex-1 rounded-md border border-zinc-200 bg-white px-2 font-mono text-xs text-zinc-800 outline-none transition focus:border-[#385772] focus:ring-2 focus:ring-[#385772] dark:border-white/10 dark:bg-white/[0.06] dark:text-white"
                          />
                          <button
                            type="button"
                            onMouseDown={handleToolbarMouseDown}
                            onClick={applyRgbSourceColor}
                            className="h-8 rounded-md bg-[#385772] px-2.5 text-xs font-bold text-white transition hover:bg-[#28465f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] dark:bg-emerald-200 dark:text-zinc-950"
                          >
                            应用
                          </button>
                        </div>
                ...
                <div className="flex h-8 items-center gap-1 rounded-md border border-zinc-200 bg-white/70 px-1.5 dark:border-white/10 dark:bg-white/[0.06]">
                  {commonTextColors.map((color) => (
                    <button
                      ...
                      onMouseDown={handleToolbarMouseDown}
                      onClick={() => applyRichTextColor(color.value)}
                      className="h-4 w-4 rounded-full border border-black/10 shadow-sm transition hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] dark:border-white/20"
                      style={{ backgroundColor: color.value }}
                    />
                  ))}
                </div>
        ...
        {popoverConfig ? (
          ...
          >
              ...
              <>
                <label className="min-w-[10rem] flex-1">
                  ...
                  <input
                    ...
                    placeholder="链接文本"
                    className="h-9 w-full rounded-md border border-zinc-200 bg-white/80 px-3 text-sm font-semibold text-zinc-800 outline-none transition placeholder:text-zinc-400 focus:border-[#385772] focus:ring-2 focus:ring-[#385772] dark:border-white/10 dark:bg-white/[0.06] dark:text-white dark:placeholder:text-zinc-500"
                  />
                </label>
            ...
            <button
              type="submit"
              className="h-9 rounded-md bg-[#385772] px-3 text-sm font-bold text-white transition hover:bg-[#28465f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] dark:bg-emerald-200 dark:text-zinc-950 dark:hover:bg-emerald-100"
            >
              插入
            </button>
            <button
      ...
      {isMarkdownMode ? (
        <div key="markdown-editor-pane" className={splitPaneClassName} data-editor-mode="markdown">
          <div className={`${splitPaneChildClassName} flex overflow-hidden bg-white/45 dark:bg-white/[0.03]`}>
            ...
            <textarea
              ...
              className={`min-w-0 flex-1 resize-none border-0 bg-transparent px-3 py-3 text-sm leading-6 text-zinc-800 outline-none placeholder:text-zinc-400 focus:ring-0 dark:text-white dark:placeholder:text-zinc-500 ${isAutoHeightEnabled ? 'min-h-[40vh]' : 'min-h-0'} ${markdownSourceOverflowClassName}`}
            />
          </div>
          <div
        ...
        <div key="html-editor-pane" className={splitPaneClassName} data-editor-mode="html">
          <div className={htmlSourcePaneClassName}>
            ...
            <div
              className={`capubbs-code-shell flex ${isAutoHeightEnabled ? 'min-h-[calc(40vh-2.25rem)]' : 'min-h-0 flex-1'}`}
        ...
        <div
          ...
          className={`capubbs-editor-prose capubbs-rich-editor-input px-3 py-3 text-sm leading-6 text-zinc-800 outline-none dark:text-zinc-100 ${isAutoHeightEnabled ? 'min-h-[40vh] overflow-visible' : 'h-[40vh] overflow-y-auto'}`}
      ...
      {richImageResizeHandle && !isSourceMode ? (
        <button
          ...
          className="absolute z-20 flex h-5 w-5 -translate-x-1/2 -translate-y-1/2 cursor-nwse-resize items-center justify-center rounded border border-[#385772] bg-white shadow-md transition hover:bg-zinc-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] dark:border-emerald-200 dark:bg-zinc-950"
          style={{
            left: `${richImageResizeHandle.left}px`,
            top: `${richImageResizeHandle.top}px`,
          }}
        >
          <span className="h-2.5 w-2.5 border-b-2 border-r-2 border-[#385772] dark:border-emerald-200" />
        </button>
      ) : null}
        ...
        <div className="flex flex-wrap items-center gap-3">
          <label className="inline-flex h-7 items-center gap-1.5 rounded-md border border-zinc-200 bg-white/60 px-2 text-[0.72rem] font-bold text-zinc-600 dark:border-white/10 dark:bg-white/[0.06] dark:text-zinc-300">
            <input
              ...
              className="h-3.5 w-3.5 accent-[#385772]"
            />
            自适应高度
          </label>
          {isSourceMode ? (
            ...
            {editorModes.map((modeOption) => {
              ...
              return (
                <button
                  ...
                  className={`h-6 rounded px-2 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#385772] ${
                    isActive
                      ? 'bg-[#385772] text-white shadow-sm dark:bg-emerald-200 dark:text-zinc-950'
                      : 'text-zinc-600 hover:bg-zinc-100 hover:text-[#385772] dark:text-zinc-300 dark:hover:bg-white/[0.08] dark:hover:text-white'
                  }`}
                >
                  {modeOption.label}
                </button>
